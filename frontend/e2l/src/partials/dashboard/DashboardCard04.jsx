...
function DashboardCard04() {
  ...
  return (
    <div className="flex flex-col col-span-full lg:col-span-6 md:col-span-6 sm:col-span-12 bg-white shadow-lg rounded-sm border border-slate-200" style={{maxHeight: '400px', overflow: 'auto'}}>
